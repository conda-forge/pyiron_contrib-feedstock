...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron_contrib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron_contrib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyiron_contrib
# for installing globally
pixi global install pyiron_contrib
```
...
It is possible to list all of the versions of `pyiron_contrib` available on your platform:
...
```
pixi search pyiron_contrib --channel conda-forge
```
